...
type ComplexityRoot struct {
	Mutation struct {
		...
		UserUpdate func(childComplexity int, input model.UpdateUser) int
	}
...
type MutationResolver interface {
	...
	UserUpdate(ctx context.Context, input model.UpdateUser) (*model.User, error)
	UserDelete(ctx context.Context, id int) (string, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.user_update":
		...
		return e.complexity.Mutation.UserUpdate(childComplexity, args["input"].(model.UpdateUser)), true
...
func (ec *executionContext) _Mutation_user_update(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UserUpdate(rctx, fc.Args["input"].(model.UpdateUser))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
